...
const Perfil = () => {
  ...
  const CargarImagen = (urlimagen) => {
    ...
    if (urlimagen != "" && urlimagen != undefined) {
      ...
      return (
        <img
          src="https://www.dermacity.com.mx/wp-content/uploads/doctor_homme_coth.png"
          alt="Admin"
          id="fotoUser"
          className="rounded-circle"
          width="150"
              ...
              return (
                <div className="container mt-5">
                  ...
                  <div
                    ...
                    id="editarFoto"
                    tabindex="-1"
                    aria-labelledby="ModalFOTO"
                    aria-hidden="true"
                  >
                    <div className="modal-dialog modal-dialog-centered">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title" id="ModalFOTO">
                            Reemplazar Foto
                          </h5>
                          <button
                            type="button"
